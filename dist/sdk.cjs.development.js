...
})(exports.Rounding || (exports.Rounding = {})); // TODO: Need to change to luaswap's factory address


var FACTORY_ADDRESS = '0x7d3f09a40a93acad98f16e56237ba6187ee0ab68'; // TODO: Need to change every code smartcontract updated

var INIT_CODE_HASH = '0x9020c8b9967def5c9eb8e0391a89bed501b113aa0435f7022a02d36b3d82a51d'; // Tomo factory address testnet: 0x1BA0DdCa35e152bE46e85e1EF9Db22d431dDc95e

var TOMO_FACTORY_ADDRESS = '0x28c79368257CD71A122409330ad2bEBA7277a396'; // Tomo init code testnet: 0x2b9f535a55a8f0b77a1508fcfc2c2ed9d6ea509f3ea06d803782ad840328d61e

var TOMO_INIT_CODE_HASH = '0xdb97fca50f04565472504aea8301c967285be031e5bdd131140734c3759d7015';
...
var _996 = /*#__PURE__*/JSBI.BigInt(996);
...
Currency.TOMO = /*#__PURE__*/new Currency(18, 'TOMO', 'TomoChain');
var ETHER = Currency.ETHER;
var TOMO = Currency.TOMO;
...
var WETH = (_WETH = {}, _WETH[exports.ChainId.MAINNET] = /*#__PURE__*/new Token(exports.ChainId.MAINNET, '0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2', 18, 'WETH', 'Wrapped Ether'), _WETH[exports.ChainId.ROPSTEN] = /*#__PURE__*/new Token(exports.ChainId.ROPSTEN, '0xc778417E063141139Fce010982780140Aa0cD5Ab', 18, 'WETH', 'Wrapped Ether'), _WETH[exports.ChainId.RINKEBY] = /*#__PURE__*/new Token(exports.ChainId.RINKEBY, '0xc778417E063141139Fce010982780140Aa0cD5Ab', 18, 'WETH', 'Wrapped Ether'), _WETH[exports.ChainId.GÖRLI] = /*#__PURE__*/new Token(exports.ChainId.GÖRLI, '0xB4FBF271143F4FBf7B91A5ded31805e42b2208d6', 18, 'WETH', 'Wrapped Ether'), _WETH[exports.ChainId.KOVAN] = /*#__PURE__*/new Token(exports.ChainId.KOVAN, '0xd0A1E359811322d97991E03f863a0C30C2cF029C', 18, 'WETH', 'Wrapped Ether'), _WETH[exports.ChainId.TOMOCHAIN_DEVNET] = /*#__PURE__*/new Token(exports.ChainId.TOMOCHAIN_DEVNET, '0xFdAA97661a584D977B4D3AbB5370766fF5b86A18', 18, 'WTOMO', 'Wrapped TOMO'), _WETH[exports.ChainId.TOMOCHAIN_TESTNET] = /*#__PURE__*/new Token(exports.ChainId.TOMOCHAIN_TESTNET, '0xB837c744A16A7f133A750254270Dce792dBBAE77', 18, 'WTOMO', 'Wrapped TOMO'), _WETH[exports.ChainId.TOMOCHAIN_MAINNET] = /*#__PURE__*/new Token(exports.ChainId.TOMOCHAIN_MAINNET, '0xB1f66997A5760428D3a87D68b90BfE0aE64121cC', 18, 'WTOMO', 'Wrapped TOMO'), _WETH[exports.ChainId.FACCHAIN] = /*#__PURE__*/new Token(exports.ChainId.FACCHAIN, '0x8c830891E20dbBb5368FDfb006cC73981B06E632', 18, 'WFAC', 'Wrapped FAC'), _WETH);
...
var CurrencyAmount = /*#__PURE__*/function (_Fraction) {
  ...
  CurrencyAmount.tomo = function tomo(amount) {
...
var Pair = /*#__PURE__*/function () {
  ...
  Pair.getAddress = function getAddress(tokenA, tokenB) {
    var _PAIR_ADDRESS_CACHE, _extends2, _extends3;

    var tokens = tokenA.sortsBefore(tokenB) ? [tokenA, tokenB] : [tokenB, tokenA]; // does safety checks

    var IsTomo = Pair.IsTomo(tokens[0].chainId);
    var factory_address = IsTomo ? TOMO_FACTORY_ADDRESS : FACTORY_ADDRESS;
    var init_code_hash = IsTomo ? TOMO_INIT_CODE_HASH : INIT_CODE_HASH; // console.log(IsTomo, factory_address,init_code_hash) 
    // if (PAIR_ADDRESS_CACHE?.[tokens[0].address]?.[tokens[1].address] === undefined) {

    PAIR_ADDRESS_CACHE = _extends({}, PAIR_ADDRESS_CACHE, (_extends3 = {}, _extends3[tokens[0].address] = _extends({}, (_PAIR_ADDRESS_CACHE = PAIR_ADDRESS_CACHE) === null || _PAIR_ADDRESS_CACHE === void 0 ? void 0 : _PAIR_ADDRESS_CACHE[tokens[0].address], (_extends2 = {}, _extends2[tokens[1].address] = address.getCreate2Address(factory_address, solidity.keccak256(['bytes'], [solidity.pack(['address', 'address'], [tokens[0].address, tokens[1].address])]), init_code_hash), _extends2)), _extends3)); // }

    return PAIR_ADDRESS_CACHE[tokens[0].address][tokens[1].address];
  } // Add function check Tomochain network
  ;

  Pair.IsTomo = function IsTomo(chainId) {
  ...
  _proto.getOutputAmount = function getOutputAmount(inputAmount) {
    ...
    var inputAmountWithFee = JSBI.multiply(inputAmount.raw, _996);
  ...
  _proto.getInputAmount = function getInputAmount(outputAmount) {
    ...
    var denominator = JSBI.multiply(JSBI.subtract(outputReserve.raw, outputAmount.raw), _996);
...
var Route = /*#__PURE__*/function () {
  function Route(pairs, input, output) {
    ...
    !(input instanceof Token && pairs[0].involvesToken(input) || (input === ETHER || input === TOMO) && pairs[0].involvesToken(WETH[pairs[0].chainId])) ?  invariant(false, 'INPUT')  : void 0;
    !(typeof output === 'undefined' || output instanceof Token && pairs[pairs.length - 1].involvesToken(output) || (output === ETHER || output === TOMO) && pairs[pairs.length - 1].involvesToken(WETH[pairs[0].chainId])) ?  invariant(false, 'OUTPUT')  : void 0;
...
var Trade = /*#__PURE__*/function () {
  function Trade(route, amount, tradeType) {
    ...
    this.inputAmount = tradeType === exports.TradeType.EXACT_INPUT ? amount : route.input === ETHER ? CurrencyAmount.ether(amounts[0].raw) : route.input === TOMO ? CurrencyAmount.tomo(amounts[0].raw) : amounts[0];
    this.outputAmount = tradeType === exports.TradeType.EXACT_OUTPUT ? amount : route.output === ETHER ? CurrencyAmount.ether(amounts[amounts.length - 1].raw) : route.output === TOMO ? CurrencyAmount.tomo(amounts[amounts.length - 1].raw) : amounts[amounts.length - 1];
...
var Router = /*#__PURE__*/function () {
  ...
  Router.swapCallParameters = function swapCallParameters(trade, options) {
    var etherIn = trade.inputAmount.currency === ETHER || trade.inputAmount.currency === TOMO;
    var etherOut = trade.outputAmount.currency === ETHER || trade.outputAmount.currency === TOMO; // the router does not support both ether in and out
...
exports.TOMO = TOMO;
exports.TOMO_FACTORY_ADDRESS = TOMO_FACTORY_ADDRESS;
exports.TOMO_INIT_CODE_HASH = TOMO_INIT_CODE_HASH;
exports.Token = Token;
