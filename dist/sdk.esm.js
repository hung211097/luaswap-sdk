...
})(Rounding || (Rounding = {})); // TODO: Need to change to luaswap's factory address
...
var WETH = (_WETH = {}, _WETH[ChainId.MAINNET] = /*#__PURE__*/new Token(ChainId.MAINNET, '0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2', 18, 'WETH', 'Wrapped Ether'), _WETH[ChainId.ROPSTEN] = /*#__PURE__*/new Token(ChainId.ROPSTEN, '0xc778417E063141139Fce010982780140Aa0cD5Ab', 18, 'WETH', 'Wrapped Ether'), _WETH[ChainId.RINKEBY] = /*#__PURE__*/new Token(ChainId.RINKEBY, '0xc778417E063141139Fce010982780140Aa0cD5Ab', 18, 'WETH', 'Wrapped Ether'), _WETH[ChainId.GÖRLI] = /*#__PURE__*/new Token(ChainId.GÖRLI, '0xB4FBF271143F4FBf7B91A5ded31805e42b2208d6', 18, 'WETH', 'Wrapped Ether'), _WETH[ChainId.KOVAN] = /*#__PURE__*/new Token(ChainId.KOVAN, '0xd0A1E359811322d97991E03f863a0C30C2cF029C', 18, 'WETH', 'Wrapped Ether'), _WETH[ChainId.TOMOCHAIN_DEVNET] = /*#__PURE__*/new Token(ChainId.TOMOCHAIN_DEVNET, '0xFdAA97661a584D977B4D3AbB5370766fF5b86A18', 18, 'WTOMO', 'Wrapped TOMO'), _WETH[ChainId.TOMOCHAIN_TESTNET] = /*#__PURE__*/new Token(ChainId.TOMOCHAIN_TESTNET, '0xB837c744A16A7f133A750254270Dce792dBBAE77', 18, 'WTOMO', 'Wrapped TOMO'), _WETH[ChainId.TOMOCHAIN_MAINNET] = /*#__PURE__*/new Token(ChainId.TOMOCHAIN_MAINNET, '0xB1f66997A5760428D3a87D68b90BfE0aE64121cC', 18, 'WTOMO', 'Wrapped TOMO'), _WETH[ChainId.FACCHAIN] = /*#__PURE__*/new Token(ChainId.FACCHAIN, '0x8c830891E20dbBb5368FDfb006cC73981B06E632', 18, 'WFAC', 'Wrapped FAC'), _WETH);
...
var Pair = /*#__PURE__*/function () {
  ...
  Pair.getAddress = function getAddress(tokenA, tokenB) {
    ...
    PAIR_ADDRESS_CACHE = _extends({}, PAIR_ADDRESS_CACHE, (_extends3 = {}, _extends3[tokens[0].address] = _extends({}, (_PAIR_ADDRESS_CACHE = PAIR_ADDRESS_CACHE) === null || _PAIR_ADDRESS_CACHE === void 0 ? void 0 : _PAIR_ADDRESS_CACHE[tokens[0].address], (_extends2 = {}, _extends2[tokens[1].address] = getCreate2Address(factory_address, keccak256(['bytes'], [pack(['address', 'address'], [tokens[0].address, tokens[1].address])]), init_code_hash), _extends2)), _extends3)); // }
...
var Route = /*#__PURE__*/function () {
  function Route(pairs, input, output) {
    ...
    !(input instanceof Token && pairs[0].involvesToken(input) || (input === ETHER || input === TOMO) && pairs[0].involvesToken(WETH[pairs[0].chainId])) ? process.env.NODE_ENV !== "production" ? invariant(false, 'INPUT') : invariant(false) : void 0;
    !(typeof output === 'undefined' || output instanceof Token && pairs[pairs.length - 1].involvesToken(output) || (output === ETHER || output === TOMO) && pairs[pairs.length - 1].involvesToken(WETH[pairs[0].chainId])) ? process.env.NODE_ENV !== "production" ? invariant(false, 'OUTPUT') : invariant(false) : void 0;
...
var Trade = /*#__PURE__*/function () {
  function Trade(route, amount, tradeType) {
    ...
    this.inputAmount = tradeType === TradeType.EXACT_INPUT ? amount : route.input === ETHER ? CurrencyAmount.ether(amounts[0].raw) : route.input === TOMO ? CurrencyAmount.tomo(amounts[0].raw) : amounts[0];
    this.outputAmount = tradeType === TradeType.EXACT_OUTPUT ? amount : route.output === ETHER ? CurrencyAmount.ether(amounts[amounts.length - 1].raw) : route.output === TOMO ? CurrencyAmount.tomo(amounts[amounts.length - 1].raw) : amounts[amounts.length - 1];
